...
import 'package:look/models/chat_model.dart';
...
import 'package:look/screens/components/messages.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    authProvider = context.read<LocalAuthProvider>();
              ...
              children: [
                chatMessages.type == MessageType.text
                    ? messageBubble(
                        ...
                        margin: const EdgeInsets.only(right: Sizes.dimen_10,top: 5),
                      )
              ...
              children: [
                ...
                chatMessages.type == MessageType.text
                    ? messageBubble(
                        ...
                        chatContent: chatMessages.content,
                        margin: const EdgeInsets.only(left: Sizes.dimen_10,top: 5),
                      )
                    : chatMessages.type == MessageType.image
                        ? Container(
                            margin: const EdgeInsets.only(
